...
interface ImzaEditorProps {
    initialContent?: string
    onChange: (content: string) => void
    authorName?: string
}

export default function ImzaEditor({ initialContent, onChange, authorName }: ImzaEditorProps) {
        ...
        extensions: [
            ...
            Placeholder.configure({
                placeholder: authorName
                    ? `${authorName}'in bu kitaptaki üslubu, tarzı, dili... Yazarın imzasını burada bırak.`
                    : "Yazarın bu kitaptaki üslubu, tarzı, dili... Yazarın imzasını burada bırak.",
            }),
            Link.configure({
                openOnClick: false,
    ...
    if (!editor) {
        return <div className="h-[300px] w-full animate-pulse rounded-lg border bg-muted" />
    }
