...
export function GoodreadsModal({ open, onOpenChange }: GoodreadsModalProps) {
    ...
    const handleScrape = async () => {
        ...
        const result = await scrapeGoodreads(url)
                ...
                {step === "input" && (
                    <>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Goodreads kitap sayfasının linkini yapıştırın
                            </DialogDescription>
                        </DialogHeader>
                                        ...
                                        onClick={async () => {
                                            try {
                                                ...
                                                if (text.trim()) {
                                                    ...
                                                    // Otomatik devam et
                                                    setStep("loading")
                                                    const result = await scrapeGoodreads(text)
                                                    if (result.success && result.data) {
                                                        setScrapedData(result.data)
                                                        setStep("preview")
                                                    } else {
                                ...
                                <div className="flex-1 space-y-2">
                                    ...
                                    {scrapedData.rating && (
                                        <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                            ...
                                            {scrapedData.rating.toFixed(2)} / 5
                                        </div>
                                    )}
